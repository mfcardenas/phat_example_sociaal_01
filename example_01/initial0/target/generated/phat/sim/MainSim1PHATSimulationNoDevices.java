 ...
 * @author pablo
 */
public class MainSim1PHATSimulationNoDevices implements PHATInitializer {
	static MonitorEventQueueImp meq=new MonitorEventQueueImp();
    public static void main(String[] args) throws RemoteException, AlreadyBoundException, NotBoundException {
    	meq.startServer(MonitorEventQueue.DefaultName);
        MainSim1PHATSimulationNoDevices sim = new MainSim1PHATSimulationNoDevices();
    ...
    public void initBodies(BodyConfigurator bodyConfig) {
       ...
       // Initial locations
       bodyConfig.setInSpace("E3Patient", "House1", "Hall");
    ...
    public void initAgents(AgentConfigurator agentsConfig) {
       ...
       {E3PatientAgent patient=new E3PatientAgent("E3Patient","Sim1" );
